...
public class LancamentoResource {
	...
	// return lancamentos.isEmpty() ? ResponseEntity.noContent().build() :
	// ResponseEntity.ok(lancamentos);
	// }
	...
	public ResponseEntity<?> handlerPessoaInvalidaException(RuntimeException e) {
		return ResponseEntity.badRequest()
				.body(messageSource.getMessage(e.getMessage(), null, LocaleContextHolder.getLocale()));
	}
